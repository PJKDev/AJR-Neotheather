...
info.onCountdownEnd(function () {
    ...
    game.showLongText("Well, congratulations on your bit of success", DialogLayout.Bottom)
    game.showLongText("Welcome to the Neotheater", DialogLayout.Bottom)
    game.showLongText("We can't wait to see what you do next", DialogLayout.Bottom)
})
...
info.onLifeZero(function () {
    ...
    game.setGameOverMessage(false, "I know I gotta grow up sometime But I'm not ready yet")
})
...
scene.setBackgroundImage(img`
    ...
    `)
game.showLongText("I gotta go so much bigger", DialogLayout.Bottom)
game.showLongText("So everybody's proud of me", DialogLayout.Bottom)
game.showLongText("Welcome to the Neotheater", DialogLayout.Bottom)
game.showLongText("Won't everybody take their seats?", DialogLayout.Bottom)
